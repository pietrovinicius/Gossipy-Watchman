...
def register_employee(
    ...
    # 2. Decode photo (BGR — InsightFace works natively with BGR)
    ...
    # 4. Extract embedding (ArcFace 512-dim, already L2-normalized)
    ...
    # 6. Save embedding
    embedding_path = settings.STORAGE_EMPLOYEES / f"{file_id}_embedding_0.npy"
