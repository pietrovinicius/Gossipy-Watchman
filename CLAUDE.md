...
As seguintes skills instaladas no ambiente são altamente pertinentes para o desenvolvimento deste projeto e podem ser usadas sempre que necessário para guiar a implementação de funcionalidades, testes e correction de bugs:
